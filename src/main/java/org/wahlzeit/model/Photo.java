 ...
 */
@Entity
@DesignPattern(name = "Abstract Factory", participants = {"Abstract Product"})
@DesignPattern(name = "Factory Method", participants = {"Product"})
@DesignPattern(name = "Flyweight", participants = {"Flyweight"})
