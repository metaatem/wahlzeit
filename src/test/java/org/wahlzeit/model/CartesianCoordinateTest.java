...
public class CartesianCoordinateTest {
	...
	public void initCoordinate() throws InvalidCoordinateValueException {
		...
		coordinate = CartesianCoordinate.getInstance(1,2,3);
		dCar1 = CartesianCoordinate.getInstance(1,2,3);
		dCar2 = CartesianCoordinate.getInstance(4,5,6);
		dCar3 = CartesianCoordinate.getInstance(-4,-5,-6);
